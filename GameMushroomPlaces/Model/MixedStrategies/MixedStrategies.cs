...
{
    /// <summary>
    /// The class that works with mixed strategies.
    /// </summary>
    public class MixedStrategies
    {
        private NearestCleanKT cleanKT = new NearestCleanKT();
        private NotYourKT notYourKt = new NotYourKT();
        private TailOfRival tailRival = new TailOfRival();
        private AttackKTRival attack = new AttackKTRival();
        private ProtectYourKT protectYourKT = new ProtectYourKT();

        private List<int[,]> resultMixStrategy = new List<int[,]>();
        private int[] scoreUpRed = new int[3];
        private int[] scoreUpBlue = new int[3];
        ...
        /// <summary>
        /// The function defines how pure strategy at this stage it is necessary to perform.
        /// </summary>
        /// <param name="BlueOrRed"></param>
        /// <param name="masGamingLocationPlay"></param>
        /// <param name="countKTblue"></param>
        /// <param name="countKTred">C</param>
        /// <param name="ran"></param>
        /// <param name="compComp"></param>
        /// <param name="flagKT"></param>
        /// <param name="countKT"></param>
